...
def scm(request,mds):
    ...
    if mds=='home':      
        connection.close
        return HttpResponse(get_template('tpscm/scm0.html').render(locals()))    
    elif mds == 'avl':
        connection.close
        return HttpResponse(get_template('tpscm/scm1.html').render(locals())) 
    elif mds == 'apl':
        connection.close
        return HttpResponse(get_template('tpscm/scm2.html').render(locals())) 
    elif mds == 'plan':
        connection.close
        return HttpResponse(get_template('tpscm/scm3.html').render(locals())) 
    elif mds == 'quatity':
        connection.close
        return HttpResponse(get_template('tpscm/scm4.html').render(locals())) 
    elif mds == 'leadtime':
        connection.close
        return HttpResponse(get_template('tpscm/scm5.html').render(locals())) 
    elif mds == 'iqc':
        connection.close
        return HttpResponse(get_template('tpscm/scm6.html').render(locals())) 
    elif mds == 'resource':
        connection.close
        return HttpResponse(get_template('tpscm/scm7.html').render(locals())) 
    elif mds == 'task':
        connection.close
        return HttpResponse(get_template('tpscm/scm8.html').render(locals())) 
    elif mds == 'query':
        connection.close
        return HttpResponse(get_template('tpscm/scm9.html').render(locals())) 
    else:
        connection.close
