...
def pdm(request,mds):
    ...
    if mds=='home':      
        connection.close
        return HttpResponse(get_template('tppdm/pdm0.html').render(locals()))  
    elif mds == 'producttree':
        connection.close
        return HttpResponse(get_template('tppdm/pdm1.html').render(locals())) 
    elif mds == 'item':
        connection.close
        return HttpResponse(get_template('tppdm/pdm2.html').render(locals())) 
    elif mds == 'bom':
        connection.close
        return HttpResponse(get_template('tppdm/pdm3.html').render(locals())) 
    elif mds == 'routing':
        connection.close
        return HttpResponse(get_template('tppdm/pdm4.html').render(locals())) 
    elif mds == 'parameter':
        connection.close
        return HttpResponse(get_template('tppdm/pdm5.html').render(locals())) 
    elif mds == 'pcn':
        connection.close
        return HttpResponse(get_template('tppdm/pdm6.html').render(locals())) 
    elif mds == 'cms':
        connection.close
        return HttpResponse(get_template('tppdm/pdm7.html').render(locals())) 
    elif mds == 'plm':
        connection.close
        return HttpResponse(get_template('tppdm/pdm8.html').render(locals())) 
    elif mds == 'query':
        connection.close
        return HttpResponse(get_template('tppdm/pdm9.html').render(locals())) 
    else:
        connection.close
